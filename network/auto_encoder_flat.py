...
class FlatAutoencoder(nn.Module):
    def __init__(self, central):
        ...
        # conv layer (depth from 16 --> 4), 3x3 kernels
        self.conv3 = nn.Conv2d(16, 8, kernel_size=3, padding=1,  stride=2)
        # conv layer (depth from 16 --> 4), 3x3 kernels
        self.conv4 = nn.Conv2d(8, 8, kernel_size=3, padding=1,  stride=2)
        self.conv5 = nn.Conv2d(8, 8, kernel_size=3, padding=1,  stride=2)
        # conv layer (depth from 16 --> 4), 3x3 kernels
        # self.conv6 = nn.Conv2d(8, 8, kernel_size=3, padding=1,  stride=1)
        ...
        self.t_conv2 = nn.ConvTranspose2d(8, 16, kernel_size=3, stride=2, output_padding=1, padding=1)
        self.t_conv3 = nn.ConvTranspose2d(16, 16, kernel_size=3, stride=2, output_padding=1, padding=1)
        self.t_conv4 = nn.ConvTranspose2d(16, 3, kernel_size=3, stride=2, output_padding=1, padding=1)
